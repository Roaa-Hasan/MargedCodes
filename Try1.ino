...
void loop() {
  ...
  if (client1 && client ) {                             // if you get a client,
      ...
      if (client1.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client1.print("Click <a href=\"/H\">here</a> to turn ON the LED.<br>");
            client1.print("Click <a href=\"/L\">here</a> to turn OFF the LED.<br>");
